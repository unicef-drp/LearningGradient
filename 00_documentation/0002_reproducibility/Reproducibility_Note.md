...
This project uses [renv](https://rstudio.github.io/renv/) to lock R package versions and support reproducible installs. Package versions are recorded in `renv.lock`, and the project environment is activated through `.Rprofile` and `renv/activate.R`. The pipeline has been tested on R 4.4.0 and above.
